...
# 앱실행
# %%
searchandclick('wannai_stap',3)
time.sleep(waitingtime)

# %% 광고끄기
searchandclick('wannai_adx',3)
time.sleep(waitingtime)

###################### 출석 럭기박스 #################################

# %%
searchandclick('wannai_lucky',3)
time.sleep(waitingtime)

# %%
searchandclick('wannai_lucky2',3)
time.sleep(waitingtime)

# %%
searchandclick('wannai_luckyop',3)
time.sleep(waitingtime)

# %%
searchandclick('wannai_luckyok',3)
time.sleep(waitingtime)
#%%
...
# %% 네시간 마다 한번씪 하루 세번 가능하지만 지금은 새벽에만 돌리기에 하루에 한번만 
searchandclick('wannai_stamp',3)
time.sleep(waitingtime)

# %%
searchandclick_byrate('wannai_stamp2',3,0.98)
time.sleep(waitingtime)
