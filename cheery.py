...
# 앱실행
# %%
searchandclick('cheery_stap',3)
time.sleep(waitingtime)

# %% 광고끄기
searchandclick('cheery_adx',3)
time.sleep(waitingtime)

# ###################### 출석 룰렛 10회 #################################
# # %% 시간이 10분이나 대기해야되서 다음에 시도
# for i in range(1,7):
#     searchandclick('cheery_lool',3)
#     time.sleep(waitingtime)
#     searchandclick_byrate('cheery_lool2',3,0.95)
#     time.sleep(waitingtime*20)
#     # 스와이프를 활용한 위치탭
#     #%%
#     device.input_swipe(1030,55,1029,56,50)
#     time.sleep(waitingtime)
#     searchandclick('cheery_adx2',3)
#     time.sleep(waitingtime)
...
# %% 
for i in range(2): # %%
    searchandclick('cheery_lott',3)
    time.sleep(waitingtime)
    searchandclick('cheery_adx',3)
    time.sleep(waitingtime)
    searchandclick('cheery_lott2',3)
...
########################## 체리 버튼 #######################################
##search and click 함수가 이미지 안 없어지면 10번은 계속 눌러서 이미지 조건 클릭형태가 되어버림.
for i in range(8):
    searchandclick('cheery_btn',3)
    time.sleep(1)
    searchandclick('cheery_adx',3)
    time.sleep(waitingtime)
#%%
