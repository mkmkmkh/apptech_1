...
# %%
# 앱실행
searchandclick('lg_stap',3)
time.sleep(waitingtime)

#%%
searchandclick('lg_ham',3)
time.sleep(waitingtime)

#%%
searchandclick('lg_reward',3)
time.sleep(waitingtime)

# %%
# 스와이프해서 아래로 내리기
device.input_swipe(0,1500,0,0,1000)

#%%
searchandclick('lg_ck',3)
time.sleep(waitingtime)
